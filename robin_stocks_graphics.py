...
############# Main Logic for Data Frame and Data Storage ####################
    ...
    ax1.pie(sizes1, labels=labels1, colors=colors, autopct=make_autopct(sizes1))
    # create first pie chart
    #ax1.pie(sizes1, labels=labels1, colors=colors, autopct='%1.1f%%')
    ax1.set_title('AST Distribution')

    # create second pie chart
    ax2.pie(sizes2, labels=labels2, colors=colors, autopct=make_autopct(sizes2))
